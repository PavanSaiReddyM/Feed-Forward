...
function getUrgency(mins) {
    if (mins <= 60) return { color: COLORS.error, label: `${mins}m`, level: "critical" };
                ...
                <View style={styles.cardTop}>
                    ...
                    <View style={styles.cardTopRight}>
                        ...
                        <View style={styles.distPill}>
                            <MaterialCommunityIcons name="map-marker" size={12} color={COLORS.accentBlue} />
                ...
                <View style={styles.cardBottom}>
                    <View style={[styles.expiryBadge, { backgroundColor: urgency.color + "15" }]}>
                        <MaterialCommunityIcons
                            name={isCritical ? "clock-alert-outline" : "clock-outline"}
                            size={14}
                            color={urgency.color}
                        />
                    ...
                    >
                        {f === "Urgent" && (
                            <MaterialCommunityIcons
                                name="clock-alert"
                                size={14}
                                color={activeFilter === f ? COLORS.white : COLORS.error}
                            />
                        )}
...
const styles = StyleSheet.create({
    ...
    cardTopRight: { flexDirection: "row", gap: 8 },
    ...
    infoText: { fontSize: 13, color: COLORS.grayText },
